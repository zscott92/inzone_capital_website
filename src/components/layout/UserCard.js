...
function UserCard() {
    ...
    return (
        <Row>
            ...
            <CardDeck>
                <Card>
                    <CardImg top width="80%" src={JimScottProfile} alt="Card image cap" className="ProfilePicture" />
                    <CardBody>
                ...
                <Card>
                    <CardImg top width="80%" src={KristineSappProfile} alt="Card image cap" className="ProfilePicture" />
                    <CardBody>
